...
public class PriorityInterceptor implements IMethodInterceptor {
	...
	/*
	 * @description : reorder the test methods execution to the order in which the methods are written
	 * @param  : list of test methods
	 * @param  : instance of ITestContext interface
	 * @return : NA
	 * @date   : 
	 * @author : Neha Agagrwal
	 */
